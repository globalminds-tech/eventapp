...
export default function ExhibitorRegister() {
  ...
  useEffect(() => {
    ...
    if (userId) {
      getUserProfile(userId)
        ...
        .catch((err) => {
          console.log("Continuity exhibitor profile fetch note:", err?.message || err);
        });
    }
  }, []);
  ...
  const autoFillDemo = () => {
    setFormData({
      ...
      company_name: "Ashok Gourmet Stalls",
      vendor_category: "Food & Beverage",
      ...
      state: "Tamil Nadu",
      pincode: "600002",
      website_url: "https://ashokstalls.com",
      bank_name: "ICICI Bank",
      account_number: "602001234567",
      ifsc_code: "ICIC0006020",
      account_holder: "Ashok Gourmet Stalls Ltd",
      upi_id: "ashokstalls@icici",
    });
    setIsOtpVerified(true);
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-2 self-end sm:self-auto shrink-0">
              <button
                ...
                className="bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 border border-emerald-500/30 px-3.5 py-1.5 rounded-xl text-xs font-bold transition cursor-pointer flex items-center gap-1.5"
              >
