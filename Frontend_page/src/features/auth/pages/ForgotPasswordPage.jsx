  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 flex items-center justify-center p-3 sm:p-5 md:p-8 font-sans select-none">
      <div className="w-full max-w-5xl bg-white rounded-2xl sm:rounded-3xl lg:rounded-[2.5rem] border border-slate-200/80 shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-0 lg:min-h-[580px]">
        ...
        {/* LEFT COLUMN: Experience Banner Matching Login Theme */}
        ...
        <div className="lg:col-span-7 p-6 sm:p-8 md:p-10 flex flex-col justify-between">
          <div>
            ...
            {/* Stepper Progress Bar (Login Orange Theme) */}
            {step < 4 && (
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3.5 py-3 bg-slate-50 border border-slate-200 focus:border-orange-500 rounded-xl text-xs font-medium focus:bg-white focus:outline-none transition-all duration-200"
                      />
                    </div>
                  </div>
            ...
            {step === 2 && (
              <div>
                ...
                {/* 5-Minute OTP Validity Banner matching email */}
                  ...
                  <div className="flex items-center justify-between gap-2 sm:gap-3" onPaste={handleOtpPaste}>
                    {otpDigits.map((digit, idx) => (
                      <input
                        ...
                        className="h-12 w-11 sm:w-12 text-center text-lg font-black rounded-xl border border-slate-200 bg-slate-50 text-slate-900 focus:border-orange-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-orange-100 transition shadow-2xs disabled:opacity-50"
                      />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center justify-between text-xs font-semibold text-slate-500 pt-1">
                    ...
                    {canResend || expirySeconds === 0 ? (
                      <button
                        ...
                        disabled={loading}
                        className="font-extrabold text-orange-600 hover:underline cursor-pointer bg-transparent border-none flex items-center gap-1"
                      >
                      ...
                      <span className="font-bold text-slate-400">
                        Resend available in <span className="text-orange-600 font-extrabold">{resendTimer}s</span>
                      </span>
                    )}
                  </div>
            ...
            {step === 3 && (
              <div>
                <div className="mb-5">
                  <h2 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">Create New Password</h2>
                  <p className="text-xs text-slate-500 font-semibold mt-1">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 pr-10 bg-slate-50 border border-slate-200 focus:border-orange-500 rounded-xl text-xs font-medium focus:bg-white focus:outline-none transition-all"
                      />
                      <button
                        type="button"
