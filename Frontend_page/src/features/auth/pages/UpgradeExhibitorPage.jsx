...
export default function UpgradeExhibitorPage() {
  ...
  useEffect(() => {
    ...
    const initialData = {
      ...
      mobile: exhProfile?.mobile || sharedKyc?.mobile || user?.mobile || "",
  ...
  const handleCompleteKYC = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("role", "exhibitor");
      sessionStorage.setItem("role", "exhibitor");
      localStorage.setItem("active_role", "exhibitor");
                ...
                <input
                  ...
                  className={`w-full p-2.5 bg-slate-50 border rounded-xl text-xs font-semibold focus:outline-none transition ${
                    fieldErrors.company_name
                      ...
                      : "border-slate-200/90 focus:bg-white focus:border-emerald-500"
                  }`}
                />
                {fieldErrors.company_name && (
                  ...
                  <Select
                    ...
                    triggerClassName={`bg-slate-50 rounded-xl h-[38px] text-xs font-semibold ${
                      fieldErrors.vendor_category
                        ...
                        : "border-slate-200/90 focus:border-emerald-500 focus:bg-white"
                    }`}
                  >
