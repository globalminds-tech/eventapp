...
export const getVendors = (organizerId) => {
  const url = organizerId ? `/superadmin/api/vendors?organizer_id=${organizerId}` : "/superadmin/api/vendors";
  return api.get(url);
};
...
// UPDATE vendor api 15-05-2026 updatevendarexport VendorsExcel exportVendorsPdf
export const updateVendor = (id, data) => {
  return api.put(`/superadmin/api/update_vendor/${id}`, data);
};

export const exportVendorsExcel = () => {
  return api.get("/superadmin/api/vendors/export/excel", { responseType: 'blob' });
};

export const exportVendorsPdf = () => {
  return api.get("/superadmin/api/vendors/export/pdf", { responseType: 'blob' });
};

// EXPORT Policies
export const exportPoliciesExcel = () => {
  return api.get("/superadmin/api/policies/export/excel", { responseType: 'blob' });
};

export const exportPoliciesPdf = () => {
  return api.get("/superadmin/api/policies/export/pdf", { responseType: 'blob' });
};
...
export const getVenues = async (organizerId) => {
  const url = organizerId ? `/superadmin/api/venues?organizer_id=${organizerId}` : "/superadmin/api/venues";
  const res = await api.get(url);
...
export const exportVenuesExcel = () => {
  return api.get("/superadmin/api/venues/export/excel", { responseType: 'blob' });
};
...
export const exportSponsorsExcel = async () => {
  const res = await api.get("/superadmin/api/sponsors/export/excel", { responseType: 'blob' });
  return res;
};

export const exportSponsorsPdf = async () => {
  const res = await api.get("/superadmin/api/sponsors/export/pdf", { responseType: 'blob' });
  return res;
};
