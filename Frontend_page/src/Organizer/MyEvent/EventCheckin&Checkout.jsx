...
import { Eye, QrCode, Users, CheckCircle2, LogOut as LogOutIcon, Search, ArrowLeft, RefreshCw } from "lucide-react";
...
export default function EventCheckIn() {
  ...
  const handleCheckIn = (id) => {
    alert("Pass checked in successfully!");
    setEntries((prev) =>
      prev.map((item) =>
        item.id === id ? { ...item, checkin_time: new Date().toLocaleTimeString() } : item
      )
    );
  };

  const handleCheckOut = (id) => {
    alert("Pass checked out successfully!");
    setEntries((prev) =>
      prev.map((item) =>
        item.id === id ? { ...item, checkout_time: new Date().toLocaleTimeString() } : item
      )
    );
  };
        ...
        <Card className="border-slate-200/80 shadow-xs">
          <CardContent className="p-5 flex items-center justify-between">
            <div className="space-y-1">
              ...
              <h3 className="text-2xl font-extrabold text-slate-900">1,450</h3>
        ...
        <Card className="border-slate-200/80 shadow-xs">
          <CardContent className="p-5 flex items-center justify-between">
            <div className="space-y-1">
              ...
              <h3 className="text-2xl font-extrabold text-emerald-600">1,185</h3>
        ...
        <Card className="border-slate-200/80 shadow-xs">
          <CardContent className="p-5 flex items-center justify-between">
            <div className="space-y-1">
              ...
              <h3 className="text-2xl font-extrabold text-slate-700">265</h3>
      ...
      {page === "entries" && (
        <Card className="border-slate-200/80 shadow-sm bg-white rounded-2xl overflow-hidden space-y-4 p-5">
          <div className="flex items-center justify-between border-b border-slate-100 pb-4">
            ...
            <Button variant="outline" onClick={() => setPage("events")} className="gap-2 cursor-pointer border-slate-200">
              <ArrowLeft size={15} />
