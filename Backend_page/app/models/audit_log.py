...
from sqlalchemy import String, Text, DateTime, func, ForeignKey, Uuid, JSON
...
class AuditLog(db.Model):
    ...
    organization_id: Mapped[Optional[uuid_pkg.UUID]] = mapped_column(Uuid, ForeignKey('organizations.id', ondelete='SET NULL'), nullable=True, index=True)
    user_id: Mapped[Optional[uuid_pkg.UUID]] = mapped_column(Uuid, ForeignKey('users.id', ondelete='SET NULL'), nullable=True, index=True)
    ...
    resource_id: Mapped[Optional[uuid_pkg.UUID]] = mapped_column(Uuid, nullable=True)
